...
test <- data.frame(NES = c(fgseaRes_S1[1,5],
                           fgseaRes_S2[1,5],
                           fgseaRes_S3[1,5],
                           fgseaRes_S4[1,5],
                           fgseaRes_S5[1,5],
...
### Create Histograms and Boxplots for Each Scenario ### ----
mQTL_probes <- read.csv("Hannum_Probes.csv")
data_mQTL <- data[data$DNAm.probe %in% mQTL_probes$DNAm.probe,]
# Generate Plots #
...
Box1 <- data_mQTL %>% select(ICC_Scen1) %>%
  ggplot(aes(x="", y = ICC_Scen1)) +
  geom_boxplot() + 
  coord_flip() +
  theme_classic() +
...
Box2 <- data_mQTL %>% select(ICC_Scen2) %>%
  ggplot(aes(x="", y = ICC_Scen2)) +
  geom_boxplot() + 
  coord_flip() +
  theme_classic() +
  labs(title = NULL, x = NULL, y = NULL) +
...
Box3 <- data_mQTL %>% select(ICC_Scen3) %>%
  ggplot(aes(x="", y = ICC_Scen3)) +
  geom_boxplot() + 
  coord_flip() +
  theme_classic() +
  labs(title = NULL, x = NULL, y = NULL) +
...
Box4 <- data_mQTL %>% select(ICC_Scen4) %>%
  ggplot(aes(x="", y = ICC_Scen4)) +
  geom_boxplot() + 
  coord_flip() +
  theme_classic() +
  labs(title = NULL, x = NULL, y = NULL) +
...
Box5 <- data_mQTL %>% select(ICC_Scen5) %>%
  ggplot(aes(x="", y = ICC_Scen5)) +
  geom_boxplot() + 
  coord_flip() +
  theme_classic() +
  labs(title = NULL, x = NULL, y = NULL) +
...
Box6 <- data_mQTL %>% select(ICC_Scen6) %>%
  ggplot(aes(x="", y = ICC_Scen6)) +
  geom_boxplot() + 
  coord_flip() +
  theme_classic() +
  labs(title = NULL, x = NULL, y = NULL) +
...
Box7 <- data_mQTL %>% select(ICC_Scen7) %>%
  ggplot(aes(x="", y = ICC_Scen7)) +
  geom_boxplot() + 
  coord_flip() +
  theme_classic() +
  labs(title = NULL, x = NULL, y = NULL) +
...
Box8 <- data_mQTL %>% select(ICC_Scen8) %>%
  ggplot(aes(x="", y = ICC_Scen8)) +
  geom_boxplot() + 
  coord_flip() +
  theme_classic() +
  labs(title = NULL, x = NULL, y = NULL) +
...
Box9 <- data_mQTL %>% select(ICC_Scen9) %>%
  ggplot(aes(x="", y = ICC_Scen9)) +
  geom_boxplot() + 
  coord_flip() +
  theme_classic() +
  labs(title = NULL, x = NULL, y = NULL) +
...
Box10 <- data_mQTL %>% select(ICC_Scen10) %>%
  ggplot(aes(x="", y = ICC_Scen10)) +
  geom_boxplot() + 
  coord_flip() +
  theme_classic() +
  labs(title = NULL, x = NULL, y = NULL) +
...
### Create Histograms and Boxplots for Each Scenario ### ----
load("sysdata.rda")
data_mQTL <- data[data$DNAm.probe %in% mPOA_Models$model_probes$DunedinPACE,]
# Generate Plots #
Hist1 <- ggplot(data, aes(x=ICC_Scen1)) + 
  geom_histogram(color="black", fill="white") +
  geom_vline(aes(xintercept=0.42),
...
### Create Histograms and Boxplots for Each Scenario ### ----
data(IDOLOptimizedCpGs)
data_mQTL <- data[data$DNAm.probe %in% IDOLOptimizedCpGs,]
# Generate Plots #
Hist1 <- ggplot(data, aes(x=ICC_Scen1)) + 
  geom_histogram(color="black", fill="white") +
  geom_vline(aes(xintercept=0.42),
...
### Create Histograms and Boxplots for Each Scenario ### ----
data(IDOLOptimizedCpGsBloodExtended)
data_mQTL <- data[data$DNAm.probe %in% IDOLOptimizedCpGsBloodExtended,]
# Generate Plots #
Hist1 <- ggplot(data, aes(x=ICC_Scen1)) + 
  geom_histogram(color="black", fill="white") +
  geom_vline(aes(xintercept=0.42),
